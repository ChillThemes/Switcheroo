$(document).ready( function() {
	...
	/* Tooltip */
	$('[rel=tipsy]').tipsy({fade: true, gravity: 's', opacity: 0.9});
	$('[rel=tipsy-n]').tipsy({fade: true, gravity: 'n', opacity: 0.9});
	$('[rel=tipsy-ne]').tipsy({fade: true, gravity: 'ne', opacity: 0.9});
	$('[rel=tipsy-nw]').tipsy({fade: true, gravity: 'nw', opacity: 0.9});
	$('[rel=tipsy-e]').tipsy({fade: true, gravity: 'e', opacity: 0.9});
	$('[rel=tipsy-w]').tipsy({fade: true, gravity: 'w', opacity: 0.9});
